...
describe("findNextNumber", () => {
    test.skip("returns the next number after the given number in the array", () => {
    ...
    test.skip("if the number is not found in the array, returns null", () => {
        expect(findNextNumber([5, 3, 7, 8, 1, 10], 55)).toBe(null);
    });

    test.skip("if the number is found more than once, returns the number after the first instance", () => {
        expect(findNextNumber([5, 3, 7, 8, 1, 3, 10], 3)).toBe(7);
    });

    test.skip("if the number is found in the final index position of the array, returns null", () => {
        expect(findNextNumber([5, 3, 7, 8, 1, 3, 10], 10)).toBe(null);
    });
});

describe("count1sand0s", () => {
    test.skip("returns an object with the count of 1s and 0s in a string", () => {
...
describe("reverseNumber", () => {
    test.skip("reverses the digits of a number", () => {
...
describe("sumArrays", () => {
    test.skip("returns the total of the numbers in all sub arrays", () => {
...
describe("arrShift", () => {
    test.skip("returns an array with the first and last items swapped", () => {
        expect(arrShift([1, 2])).toEqual([2, 1]);
        expect(arrShift([1, 2, 3])).toEqual([3, 2, 1]);
        expect(arrShift([1, 2, 3, 4])).toEqual([4, 2, 3, 1]);
    });

    test.skip("makes no difference when the array length is < 2", () => {
...
describe("findNeedle", () => {
    test.skip("returns true if any of the properties of an object contain the specified string", () => {
        const obj1 = {
            name: "LINNMON",
    ...
    test.skip("returns false if none of the properties of an object contain the specified string", () => {
        const obj1 = {
            name: "LINNMON",
            description: "Small round table",
            price: 31.89,
    ...
    test.skip("The search string should not be case sensitive", () => {
        const obj1 = {
            name: "LINNMON",
            description: "Small round table",
            price: 31.89,
...
describe("getWordFrequencies", () => {
    test.skip("returns the frequencies of each word in a string", () => {
    ...
    test.skip("ignores capitalisation", () => {
        expect(getWordFrequencies("Hello hello hello")).toEqual({
            hello: 3,
        });
    });
